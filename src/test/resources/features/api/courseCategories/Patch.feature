Feature: As an administrator, I want to be able to update the information of the course category with the
  ...
  response matches the {id} path parameter.
    ...
    * The api user sets "api/updateCategory/911" path parameters.
    ...
    * The api user sends a PATCH request to updateCategory and saves the responsed.
    * The api user verifies that the "Updated Category Id" information in the response body is the same as the id path parameter in the endpointt.
