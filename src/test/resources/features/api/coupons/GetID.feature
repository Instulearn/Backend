...
Feature: Bir yönetici olarak API baglantisi üzerinden belirtilen id numarasına sahip coupon'un detaylı bilgilerine erisebilmeliyim.
  ...
  "There is not coupon for this id." olması gerekir.
    ...
    * Api kullanicisi "admin" tokeniyla base urli olusturur
    * Api kullanicisi "api/coupon/11" ile path parametrelerini olusturur.
    * Api kullanicisi GET request gonderir ve donen responsei da kaydeder
    * Api kullanicisi status codeunun 203 oldugunu dogrular
  ...
  status kodunun 203, remark bilgisinin "failed" ve message bilgisinin "No id" oldugu doğrulanmalıdır.
    ...
    * Api kullanicisi "admin" tokeniyla base urli olusturur
    * Api kullanicisi "api/coupon" ile path parametrelerini olusturur.
    * Api kullanicisi GET request gonderir ve donen responsei da kaydeder
    * Api kullanicisi status codeunun 203 oldugunu dogrular
    * Api kullanicisi response bodydeki "remark" bilgisinin "failed" oldugunu dogrular.
