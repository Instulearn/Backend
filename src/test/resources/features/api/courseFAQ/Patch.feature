Feature: As an administrator, I want to be able to update the information of the course faq with the specified
  ...
  “Successfully Updated.”.
    ...
    * The api user prepares a patch request body to send to the api updateCategory endpoint with the "<title>", "<answer>".
  ...
  Scenario Outline: When a PATCH body is sent to /api/updateWhat are the key features that differentiate your online learning platform from others? Updated/{id} endpoint with invalid token authorization
  ...
  code returned is 401 and the message information in the response body is “Unauthenticated.”
    ...
    * The api user sets "api/updateCoursefaq/<id>" path parameters.
    # Api kullanicisi "api/updatePrWhat are the key features that differentiate your online learning platform from others? Updatedoductfaq/<id>" path parametrelerini olusturur
    * The api user prepares a patch request body to send to the api updateCategory endpoint with the "<title>", "<answer>".
    # Api kullanicisi api updateCategory endpointine gondermek icin bir patch request body hazirlar
